...
#Since transaction and block need the same __repr__ method, we can use inheritance (creating an own class that is called within our Block and Transaction class)
